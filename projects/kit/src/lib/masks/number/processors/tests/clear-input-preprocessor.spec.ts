...
describe('createClearInputPreprocessor', () => {
    describe('correctly works with prefix and postfix', () => {
        ...
        const process = (
            ...
            processor({elementState: {value, selection}, data: ''}, type).elementState;
    ...
    describe('simple tests', () => {
        ...
        it('41233.2|12|3 => deleteBackward => 41233.2|300', () => {
            const {value, selection} = process('41233.2123', [7, 9], 'deleteBackward');
        ...
        it('4123|3.2|123 => deleteBackward => 4123|.1230', () => {
            const {value, selection} = process('41233.2123', [4, 7], 'deleteBackward');
        ...
        it('41|233|.2123 => deleteBackward => 41|.2123', () => {
            const {value, selection} = process('41233.2123', [2, 5], 'deleteBackward');
