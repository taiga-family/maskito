...
import {DateTimeMaskDocExample4} from './examples/4-strict-mode/component';
...
export class DateTimeMaskDocComponent implements GeneratorOptions {
    ...
    protected readonly strictModeExample: TuiDocExample = {
        [DocExamplePrimaryTab.MaskitoOptions]: import(
            './examples/4-strict-mode/mask.ts?raw'
        ),
    };
