...
import {PageMarkdownService} from './page-markdown.service';
...
export class CopyPageComponent {
    private readonly pageMarkdown = inject(PageMarkdownService);
...
export const COPY_PAGE_CONTENT = new PolymorpheusComponent(CopyPageComponent);
